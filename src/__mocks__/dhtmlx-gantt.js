...
const gantt = {
  ...
  __resetMocks: () => {
    ...
    gantt.date.date_to_str.mockClear().mockImplementation(format => jest.fn(date => 'mock-date-string'));
    ...
    gantt.config = {
      date_format: '', columns: [], drag_resize: false, drag_move: false, work_time: false, skip_off_time: false, autosize: false,
